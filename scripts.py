...
def book_to_xlsx(book, output):
    ...
    with open('books/' + book, 'r', errors="ignore", encoding="utf-8") as file:
        ...
        for line_id, line in enumerate(file):
            ...
            d_parent, d_subsidiary, d_waste, d_part_prev_line, d_country_match, d_match = 0, 0, 0, 0, 0, 0
            ...
            rows.append([line_id + 1, line, d_parent, d_subsidiary, d_waste, d_part_prev_line, d_subsidiary_country, d_country_match, d_iso, industry])
    ...
    book_data = pd.DataFrame(rows, columns = ["line_id", "line_orig", "d_parent", "d_subsidiary", "d_waste", "d_part_prev_line", "d_subsidiary_country", "d_country_match", "d_iso", "industry"])
